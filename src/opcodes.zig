...
pub fn opcode_info(opcode: u8) types.OpcodeInfo {
    return switch (opcode) {
        ...
        0xC7 => types.OpcodeInfo{ .instruction = .dcp, .mode = .zero_page },
        0xD7 => types.OpcodeInfo{ .instruction = .dcp, .mode = .zero_page_x },
        0xCF => types.OpcodeInfo{ .instruction = .dcp, .mode = .absolute },
        0xDF => types.OpcodeInfo{ .instruction = .dcp, .mode = .absolute_x },
        0xDB => types.OpcodeInfo{ .instruction = .dcp, .mode = .absolute_y },
        0xC3 => types.OpcodeInfo{ .instruction = .dcp, .mode = .indirect_x },
        0xD3 => types.OpcodeInfo{ .instruction = .dcp, .mode = .indirect_y },

        0xE7 => types.OpcodeInfo{ .instruction = .isc, .mode = .zero_page },
        0xF7 => types.OpcodeInfo{ .instruction = .isc, .mode = .zero_page_x },
        0xEF => types.OpcodeInfo{ .instruction = .isc, .mode = .absolute },
        0xFF => types.OpcodeInfo{ .instruction = .isc, .mode = .absolute_x },
        0xFB => types.OpcodeInfo{ .instruction = .isc, .mode = .absolute_y },
        ...
        0x47 => types.OpcodeInfo{ .instruction = .sre, .mode = .zero_page },
        0x57 => types.OpcodeInfo{ .instruction = .sre, .mode = .zero_page_x },
        0x4F => types.OpcodeInfo{ .instruction = .sre, .mode = .absolute },
        0x5F => types.OpcodeInfo{ .instruction = .sre, .mode = .absolute_x },
        0x5B => types.OpcodeInfo{ .instruction = .sre, .mode = .absolute_y },
        0x43 => types.OpcodeInfo{ .instruction = .sre, .mode = .indirect_x },
        0x53 => types.OpcodeInfo{ .instruction = .sre, .mode = .indirect_y },

        0x67 => types.OpcodeInfo{ .instruction = .rra, .mode = .zero_page },
        0x77 => types.OpcodeInfo{ .instruction = .rra, .mode = .zero_page_x },
        0x6F => types.OpcodeInfo{ .instruction = .rra, .mode = .absolute },
        0x7F => types.OpcodeInfo{ .instruction = .rra, .mode = .absolute_x },
        0x7B => types.OpcodeInfo{ .instruction = .rra, .mode = .absolute_y },
        0x63 => types.OpcodeInfo{ .instruction = .rra, .mode = .indirect_x },
        0x73 => types.OpcodeInfo{ .instruction = .rra, .mode = .indirect_y },
